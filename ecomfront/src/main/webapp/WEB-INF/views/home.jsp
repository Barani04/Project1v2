						...
						<div id="carousel-example-generic" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="item active">
									<img class="slide-image" src="${images}/slider/placeholder.jpg"
										alt="">
								</div>
								<div class="item">
									<img class="slide-image" src="${images}/slider/placeholder1.jpg"
										alt="">
								</div>
								<div class="item">
									<img class="slide-image" src="${images}/slider/placeholder2.jpg"
										alt="">
								</div>
							</div>
